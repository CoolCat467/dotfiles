...
class SearchEngine:
    ...
    def report_error(
        self, pat: Pattern[str], msg: str, col: int | None = ...
    ) -> None: ...
    def search_text(
        self, text: Text, prog: Pattern[str] | None = ..., ok: int = ...
    ) -> tuple[int, Match[str]]: ...
    def search_forward(
        self,
        text: Text,
...
def search_reverse(
    prog: Pattern[str], chars: str, col: int
) -> Match[str] | None: ...
def get_selection(text: Text) -> tuple[str, str]: ...
