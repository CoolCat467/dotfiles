...
def get_widget_padding(widget: Misc) -> tuple[int, int]: ...
...
class BaseSideBar:
    ...
    def redirect_focusin_event(self, event: Event[Any] | None) -> str: ...
    def redirect_mousebutton_event(
        self, event: Event[Any] | None, event_name: str
    ) -> str: ...
    def redirect_mousewheel_event(self, event: Event[Any] | None) -> str: ...
    def bind_events(self) -> None: ...

class EndLineDelegator(Delegator):
    changed_callback: Callable[[int | None], Any]
    def __init__(
        self, changed_callback: Callable[[int | None], Any]
    ) -> None: ...
    def insert(
