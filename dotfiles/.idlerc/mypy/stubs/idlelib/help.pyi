...
from tkinter import Misc, Text, Toplevel
...
class HelpText(Text):
    parser: HelpParser
    def __init__(self, parent: Misc, filename: str) -> None: ...
...
class HelpWindow(Toplevel):
    def __init__(self, parent: Misc, filename: str, title: str) -> None: ...

def copy_strip() -> None: ...
def show_idlehelp(parent: Misc) -> None: ...
